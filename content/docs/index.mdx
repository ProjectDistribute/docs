...
To download the DistributeApp, visit the [official GitHub releases](https://github.com/ProjectDistribute/Distribute/releases). Choose the version that corresponds to your operating system (Windows, macOS, Linux, iOS, Android). That's the easy part.
